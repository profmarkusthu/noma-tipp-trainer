export function generateSequence(lesson, length = 30) {
...
export function generateCharacterSequence(characters, length) {
    const result = [];
    let lastChar = '';
...
export function generateWordSequence(words, length) {
    const result = [];
    for (let i = 0; i < length; i++) {
